...
// console.log('ana0are0mere'.split('0'));
...
// console.log(maskCreditCard(248628489));
...
//   console.log(`Part of this family`);
// }
...
// const result =
//   num1 > num2 ? 'Numărul 1 este mai mare' : 'Numărul 2 este mai mare sau egal';

// console.log(result);

// const users = [{ name: 'Jonas', email: 'hello@jonas.io' }];

// console.log(users[0]?.name ?? 'stop');
...
// printGoals('Davies', 'Muller', 'Lewandovski', 'Kimicch');
...
//nullsih assigment operator(null or undefined)
rest1.numGuest ??= 10;
rest2.numGuest ??= 10;
...
//Objects
const newRestaurant = { fondedIn: 1988, ...restaurant, founder: 'Giuseppe' };
